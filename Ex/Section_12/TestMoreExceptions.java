...
{
	/** Main method with argument[0]: 0 - sample exception, 1 - sample exception 1, 2 - sample exception 2, non - no exceptions */
	public static void main(String[] args) throws SampleException, SampleException1, SampleException2
	{
		...
		try
		{
			...
			{
				case '0': throw new SampleException();
				case '1': throw new SampleException1();
				case '2': throw new SampleException2();
				default: System.out.println("No exception has been throw...");
			}
