...
final class SynthesisFilter
{
  ...
  {
    this.samples[paramInt] = (this.eq[paramInt] * paramFloat);
  }
  
  public void input_samples(float[] paramArrayOfFloat)
  {
    for (int i = 31; i >= 0; i--) {
      this.samples[i] = (paramArrayOfFloat[i] * this.eq[i]);
    }
  }
  ...
  private void compute_new_v()
  {
    ...
    float f29 = f97 - f98;
    float[] arrayOfFloat2 = this.actual_v;
    ...
    arrayOfFloat2 = this.actual_v == this.v1 ? this.v2 : this.v1;
    arrayOfFloat2[(0 + i)] = (-f1);
  ...
  private void compute_new_v_old()
  {
    ...
    float[] arrayOfFloat4 = this.samples;
    ...
    arrayOfFloat1[19] = (-(arrayOfFloat1[4] = (arrayOfFloat1[12] = arrayOfFloat2[7]) + arrayOfFloat2[5]) - arrayOfFloat2[6]);
    arrayOfFloat1[27] = (-arrayOfFloat2[6] - arrayOfFloat2[7] - arrayOfFloat2[4]);
    arrayOfFloat1[6] = ((arrayOfFloat1[10] = (arrayOfFloat1[14] = arrayOfFloat2[15]) + arrayOfFloat2[11]) + arrayOfFloat2[13]);
    arrayOfFloat1[17] = (-(arrayOfFloat1[2] = arrayOfFloat2[15] + arrayOfFloat2[13] + arrayOfFloat2[9]) - arrayOfFloat2[14]);
    float f1;
    arrayOfFloat1[21] = ((f1 = -arrayOfFloat2[14] - arrayOfFloat2[15] - arrayOfFloat2[10] - arrayOfFloat2[11]) - arrayOfFloat2[13]);
    ...
    arrayOfFloat1[23] = (-(arrayOfFloat1[8] = arrayOfFloat2[3]) - arrayOfFloat2[2]);
    ...
    arrayOfFloat3[14] += arrayOfFloat3[15];
    arrayOfFloat2[15] = ((arrayOfFloat3[14] - arrayOfFloat3[15]) * cos1_4);
    arrayOfFloat1[5] = ((arrayOfFloat1[11] = (arrayOfFloat1[13] = (arrayOfFloat1[15] = arrayOfFloat2[15]) + arrayOfFloat2[7]) + arrayOfFloat2[11]) + arrayOfFloat2[5] + arrayOfFloat2[13]);
    arrayOfFloat1[7] = ((arrayOfFloat1[9] = arrayOfFloat2[15] + arrayOfFloat2[11] + arrayOfFloat2[3]) + arrayOfFloat2[13]);
    arrayOfFloat1[16] = (-(arrayOfFloat1[1] = (f1 = arrayOfFloat2[13] + arrayOfFloat2[15] + arrayOfFloat2[9]) + arrayOfFloat2[1]) - arrayOfFloat2[14]);
    arrayOfFloat1[18] = (-(arrayOfFloat1[3] = f1 + arrayOfFloat2[5] + arrayOfFloat2[7]) - arrayOfFloat2[6] - arrayOfFloat2[14]);
    arrayOfFloat1[22] = ((f1 = -arrayOfFloat2[10] - arrayOfFloat2[11] - arrayOfFloat2[14] - arrayOfFloat2[15]) - arrayOfFloat2[13] - arrayOfFloat2[2] - arrayOfFloat2[3]);
    ...
    float f2;
    arrayOfFloat1[26] = (f1 - arrayOfFloat2[12] - (f2 = arrayOfFloat2[4] + arrayOfFloat2[6] + arrayOfFloat2[7]));
    arrayOfFloat1[30] = ((f1 = -arrayOfFloat2[8] - arrayOfFloat2[12] - arrayOfFloat2[14] - arrayOfFloat2[15]) - arrayOfFloat2[0]);
    arrayOfFloat1[28] = (f1 - f2);
    arrayOfFloat4 = arrayOfFloat1;
    float[] arrayOfFloat5 = this.actual_v;
    arrayOfFloat5[(0 + this.actual_write_pos)] = arrayOfFloat4[0];
    arrayOfFloat5[(16 + this.actual_write_pos)] = arrayOfFloat4[1];
    arrayOfFloat5[(32 + this.actual_write_pos)] = arrayOfFloat4[2];
    arrayOfFloat5[(48 + this.actual_write_pos)] = arrayOfFloat4[3];
    arrayOfFloat5[(64 + this.actual_write_pos)] = arrayOfFloat4[4];
    arrayOfFloat5[(80 + this.actual_write_pos)] = arrayOfFloat4[5];
    arrayOfFloat5[(96 + this.actual_write_pos)] = arrayOfFloat4[6];
    arrayOfFloat5[(112 + this.actual_write_pos)] = arrayOfFloat4[7];
    arrayOfFloat5[(128 + this.actual_write_pos)] = arrayOfFloat4[8];
    arrayOfFloat5[(144 + this.actual_write_pos)] = arrayOfFloat4[9];
    arrayOfFloat5[(160 + this.actual_write_pos)] = arrayOfFloat4[10];
    arrayOfFloat5[(176 + this.actual_write_pos)] = arrayOfFloat4[11];
    arrayOfFloat5[(192 + this.actual_write_pos)] = arrayOfFloat4[12];
    arrayOfFloat5[(208 + this.actual_write_pos)] = arrayOfFloat4[13];
    arrayOfFloat5[(224 + this.actual_write_pos)] = arrayOfFloat4[14];
    arrayOfFloat5[(240 + this.actual_write_pos)] = arrayOfFloat4[15];
    arrayOfFloat5[(256 + this.actual_write_pos)] = 0.0F;
    arrayOfFloat5[(272 + this.actual_write_pos)] = (-arrayOfFloat4[15]);
    arrayOfFloat5[(288 + this.actual_write_pos)] = (-arrayOfFloat4[14]);
    arrayOfFloat5[(304 + this.actual_write_pos)] = (-arrayOfFloat4[13]);
    arrayOfFloat5[(320 + this.actual_write_pos)] = (-arrayOfFloat4[12]);
    arrayOfFloat5[(336 + this.actual_write_pos)] = (-arrayOfFloat4[11]);
    arrayOfFloat5[(352 + this.actual_write_pos)] = (-arrayOfFloat4[10]);
    arrayOfFloat5[(368 + this.actual_write_pos)] = (-arrayOfFloat4[9]);
    arrayOfFloat5[(384 + this.actual_write_pos)] = (-arrayOfFloat4[8]);
    arrayOfFloat5[(400 + this.actual_write_pos)] = (-arrayOfFloat4[7]);
    arrayOfFloat5[(416 + this.actual_write_pos)] = (-arrayOfFloat4[6]);
    arrayOfFloat5[(432 + this.actual_write_pos)] = (-arrayOfFloat4[5]);
    arrayOfFloat5[(448 + this.actual_write_pos)] = (-arrayOfFloat4[4]);
    arrayOfFloat5[(464 + this.actual_write_pos)] = (-arrayOfFloat4[3]);
    arrayOfFloat5[(480 + this.actual_write_pos)] = (-arrayOfFloat4[2]);
    arrayOfFloat5[(496 + this.actual_write_pos)] = (-arrayOfFloat4[1]);
  }
  
  private void compute_pcm_samples0(Obuffer paramObuffer)
  {
    float[] arrayOfFloat1 = this.actual_v;
    float[] arrayOfFloat2 = this._tmpOut;
    int i = 0;
    for (int j = 0; j < 32; j++)
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(0 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples1(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(1 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples2(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(2 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples3(Obuffer paramObuffer)
  {
    ...
    for (int k = 0; k < 32; k++)
    {
      ...
      float f = (arrayOfFloat1[(3 + j)] * arrayOfFloat3[0] + arrayOfFloat1[(2 + j)] * arrayOfFloat3[1] + arrayOfFloat1[(1 + j)] * arrayOfFloat3[2] + arrayOfFloat1[(0 + j)] * arrayOfFloat3[3] + arrayOfFloat1[(15 + j)] * arrayOfFloat3[4] + arrayOfFloat1[(14 + j)] * arrayOfFloat3[5] + arrayOfFloat1[(13 + j)] * arrayOfFloat3[6] + arrayOfFloat1[(12 + j)] * arrayOfFloat3[7] + arrayOfFloat1[(11 + j)] * arrayOfFloat3[8] + arrayOfFloat1[(10 + j)] * arrayOfFloat3[9] + arrayOfFloat1[(9 + j)] * arrayOfFloat3[10] + arrayOfFloat1[(8 + j)] * arrayOfFloat3[11] + arrayOfFloat1[(7 + j)] * arrayOfFloat3[12] + arrayOfFloat1[(6 + j)] * arrayOfFloat3[13] + arrayOfFloat1[(5 + j)] * arrayOfFloat3[14] + arrayOfFloat1[(4 + j)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[k] = f;
      j += 16;
    }
  }
  ...
  private void compute_pcm_samples4(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(4 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples5(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(5 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples6(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(6 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples7(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(7 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples8(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(8 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples9(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(9 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples10(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(10 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples11(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(11 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples12(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(12 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples13(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(13 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples14(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(14 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(15 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples15(Obuffer paramObuffer)
  {
    ...
    {
      float[] arrayOfFloat3 = d16[j];
      float f = (arrayOfFloat1[(15 + i)] * arrayOfFloat3[0] + arrayOfFloat1[(14 + i)] * arrayOfFloat3[1] + arrayOfFloat1[(13 + i)] * arrayOfFloat3[2] + arrayOfFloat1[(12 + i)] * arrayOfFloat3[3] + arrayOfFloat1[(11 + i)] * arrayOfFloat3[4] + arrayOfFloat1[(10 + i)] * arrayOfFloat3[5] + arrayOfFloat1[(9 + i)] * arrayOfFloat3[6] + arrayOfFloat1[(8 + i)] * arrayOfFloat3[7] + arrayOfFloat1[(7 + i)] * arrayOfFloat3[8] + arrayOfFloat1[(6 + i)] * arrayOfFloat3[9] + arrayOfFloat1[(5 + i)] * arrayOfFloat3[10] + arrayOfFloat1[(4 + i)] * arrayOfFloat3[11] + arrayOfFloat1[(3 + i)] * arrayOfFloat3[12] + arrayOfFloat1[(2 + i)] * arrayOfFloat3[13] + arrayOfFloat1[(1 + i)] * arrayOfFloat3[14] + arrayOfFloat1[(0 + i)] * arrayOfFloat3[15]) * this.scalefactor;
      arrayOfFloat2[j] = f;
      i += 16;
    }
  }
  ...
  private void compute_pcm_samples(Obuffer paramObuffer)
  {
    ...
    if (paramObuffer != null) {
      paramObuffer.appendSamples(this.channel, this._tmpOut);
    }
  }
...
/* Location:              F:\Java\jl1.0.1.jar!\javazoom\jl\decoder\SynthesisFilter.class
