...
public class Converter
{
    ...
    implements Converter.ProgressListener
  {
    ...
    public PrintWriterProgressListener(PrintWriter paramPrintWriter, int paramInt)
    {
      ...
      this.detailLevel = paramInt;
    }
    
    public boolean isDetail(int paramInt)
    {
      return this.detailLevel >= paramInt;
    }
    ...
    public void converterUpdate(int paramInt1, int paramInt2, int paramInt3)
    {
      if (isDetail(2)) {
        ...
        case 2: 
          ...
          this.pw.println();
          this.pw.println("Converted " + paramInt3 + " frames in " + paramInt2 + " ms (" + paramInt2 / paramInt3 + " ms per frame.)");
        }
      }
    }
    ...
    public void parsedFrame(int paramInt, Header paramHeader)
    {
      ...
      if ((paramInt == 0) && (isDetail(2)))
      {
        ...
        this.pw.println("File is a " + str);
      }
      else if (isDetail(10))
      {
        str = paramHeader.toString();
        this.pw.println("Prased frame " + paramInt + ": " + str);
      }
    }
    ...
    public void readFrame(int paramInt, Header paramHeader)
    {
      ...
      {
        str = paramHeader.toString();
        this.pw.println("Read frame " + paramInt + ": " + str);
      }
    }
    ...
    public void decodedFrame(int paramInt, Header paramHeader, Obuffer paramObuffer)
    {
      if (isDetail(10))
      {
        ...
        this.pw.println("Decoded frame " + paramInt + ": " + str);
        this.pw.println("Output: " + paramObuffer);
      }
      else if (isDetail(2))
      {
        if (paramInt == 0)
    ...
    public boolean converterException(Throwable paramThrowable)
    {
      ...
      {
        paramThrowable.printStackTrace(this.pw);
        this.pw.flush();
      }
      return false;
    }
...
/* Location:              F:\Java\jl1.0.1.jar!\javazoom\jl\converter\Converter.class
