...
public class StringEncryptor {
	...
	public void setEncodeSeed(long seed){
		...
		for(i=0;i<27;i++){
			...
			Character ch1=new Character(sb1.charAt(j));
			Character ch2=new Character(sb2.charAt(k));
			keyMap1.put(ch1,ch2);
			keyMap2.put(ch2,ch1);
	...
	public String encode2(String orig){
		StringBuffer sb=new StringBuffer();//orig.length()
		for(int i=0;i<orig.length();i++){
			Character ch1=new Character(orig.charAt(i));
	...
	public String decode2(String encode){
		StringBuffer sb=new StringBuffer();//encode.length()
		for(int i=0;i<encode.length();i++){
			Character ch2=new Character(encode.charAt(i));
